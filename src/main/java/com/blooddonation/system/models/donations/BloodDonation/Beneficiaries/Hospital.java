...
@Entity
public class Hospital implements Beneficiary {
    ...
    @ElementCollection
    @CollectionTable(name = "hospital_blood_storage", joinColumns = @JoinColumn(name = "hospital_id"))
    ...
    public Hospital(IBloodStock bloodStock) {
